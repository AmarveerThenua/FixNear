...
const ManageProfessionals = () => {
  ...
  const fetchProfessionals = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:5000/api/professionals/admin/all",
        {
          headers: {
  ...
  const handleVerify = async (professional) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:5000/api/professionals/admin/${professional._id}/verify`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUnverify = async (professional) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:5000/api/professionals/admin/${professional._id}/unverify`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleToggleAvailability = async (
    ...
    try {
      ...
      await axios.put(
        `http://localhost:5000/api/professionals/admin/${professional._id}/availability`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (professional) => {
    ...
    try {
      ...
      await axios.delete(
        `http://localhost:5000/api/professionals/admin/${professional._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      setProfessionals((previous) =>
        previous.filter(
          (item) => item._id !== professional._id
        )
      );
