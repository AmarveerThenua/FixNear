                ...
                >
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 min-w-0">
                    ...
                    <div className="min-w-0 lg:flex-1">
                      ...
                      <p className="mt-1 text-blue-600 font-medium bwrap-break-word">
                        {booking.service}
                      </p>

                      <p className="mt-2 text-sm text-gray-500 bwrap-break-word">
                        📞{" "}
                        {booking.user?.phone ||
                          "Phone not available"}
                      </p>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-5 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 font-medium text-gray-900 bwrap-break-word">
                          {booking.time}
                        </p>
                      </div>
                  ...
                  <div className="mt-5 pt-5 border-t border-gray-100 min-w-0">
                    ...
                    <p className="mt-1 text-gray-700 wrap-break-word overflow-hidden">
                      {booking.address},{" "}
                      {booking.city} -{" "}
                      {booking.pincode}
                    </p>
                  ...
                  {booking.description && (
                    <div className="mt-4 min-w-0">
                      ...
                      <p className="mt-1 text-gray-700 bwrap-break-word overflow-hidden">
                        {booking.description}
                      </p>
