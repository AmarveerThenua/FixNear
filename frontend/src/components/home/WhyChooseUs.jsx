      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {features.map((feature) => (
            ...
            <div
              key={feature.id}
              className="bg-white p-7 rounded-2xl border border-gray-100 text-center hover:shadow-lg transition duration-300"
            >

      
              <div className="w-14 h-14 mx-auto flex items-center justify-center rounded-full bg-blue-50 text-blue-600 text-2xl">
                {feature.icon}
              </div>
